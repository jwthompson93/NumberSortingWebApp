...
namespace NumberSortingTests.Algorithm.Sorting
{
    public class QuicksortTests
    {
        ...
        {
            int[] sortedArray = sortingAlgorithm.Sort(unsortedArray, SortDirection.Ascending);
        ...
        {
            int[] sortedArray = sortingAlgorithm.Sort(unsortedArray, SortDirection.Descending);
            Assert.That(sortedArray, Is.EqualTo(expectedArray));
        }
    }
}